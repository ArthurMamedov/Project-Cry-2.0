...
namespace ProjectCry {
	constexpr static int ANUBIS_BLOCK_LENGTH = 16;
	...
	private:
		...
		const uint8_t matrixH[ANUBIS_BLOCK_LENGTH] = { 1, 2, 4, 6, 2, 1, 6, 4, 4, 6, 1, 2, 6, 4, 2, 1 };
		const uint8_t inv_matrixH[ANUBIS_BLOCK_LENGTH] = { 153, 238, 116, 202, 238, 153, 202, 116, 116, 202, 153, 238, 202, 116, 238, 153 };

		const uint8_t matrixV[ANUBIS_BLOCK_LENGTH] { 1, 1, 1, 1, 1, 2, 4, 8, 1, 6, 36, 216, 1, 8, 64, 0 };
		size_t _round_number = 0;
